// Static completion list for Lumen Script -- context-free by design (v1):
...
// item here comes straight from LUMEN_SCRIPT-GRAMMAR.md (keywords, §2) and
...
const FUNCTIONS = [
  ...
  fn('render', 'render(${1:"template.html"}, ${2:key}=${3:value})', 'render(template, k=v, ...) -- renders a Lumen Script template'),
