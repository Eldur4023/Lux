...
LUX_MODULE(math, {
    ...
    {"floor",      "n",   fn_floor},
    {"ceil",       "n",   fn_ceil},
    {"sqrt",       "n",   unary<std::sqrt>},
    {"exp",        "n",   unary<std::exp>},
    {"log",        "n|n", fn_log},
    {"log10",      "n",   unary<std::log10>},
    {"pow",        "nn",  fn_pow},
    {"sin",        "n",   unary<std::sin>},
    {"cos",        "n",   unary<std::cos>},
    {"tan",        "n",   unary<std::tan>},
    {"asin",       "n",   unary<std::asin>},
    {"acos",       "n",   unary<std::acos>},
    {"atan",       "n",   unary<std::atan>},
    {"atan2",      "nn",  fn_atan2},
    {"hypot",      "nn",  fn_hypot},
    {"pi",         "",    fn_pi},
    {"e",          "",    fn_e},
    {"random",     "",    fn_random},
    {"random_int", "ii",  fn_random_int},
    {"choice",     "l",   fn_choice},
    {"shuffle",    "l",   fn_shuffle},
    {"sample",     "li",  fn_shuffle},
})
